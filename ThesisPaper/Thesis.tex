...
\pagebreak
	...
	\section{Algorithm Comparison}
		...
		\begin{itemize}
			...
			\item \textbf{Projection Plots:} are plots that show the path that the pendulum bob took while going from $x_0$ to $x_N$
		\end{itemize}
		...
		\begin{figure}[h!]
			...
			\caption{Projection plot of Modified SE1 for k=0.25 h=10.0 N=200, m=1.0, and $\mathbf{x_0} = (-1.11, 2.12)$}
			\label{fig:example_projection_plot}
		\end{figure}

		\noindent Figure~\ref{fig:example_projection_plot} shows the projection plot of the Modified SE1 for the parameter values of $k=0.25$, $h=10.0$, $N=200$, $m=1.0$, $x_d = (0.00, 10.00)$
		and initial value $x_0 = (-1.11, 2.12)$. The projection plots shows the trajectory through the state space that the pendulum bob took to get to its final position as marked on the Iteration Plot (Figure~\ref{fig:example_iter_plot})
...
\subsection{SE1}
{
	...
	% --------------------------
	% Projection comparison for x0 = xA
	% --------------------------
	\begin{figure}[h!]
		\centering
		...
		\caption{Projection comparison for $x_0=\xA$ with
			$k=\kval$, $h=\hval$, $N=\Nval$, $m=\mval$.}
	...
	% --------------------------
	% Projection comparison for x0 = xB
	% --------------------------
	\begin{figure}[h!]
		\centering
		\includegraphics[width=\textwidth]{../Images/Projection_Comparison_PyPlots/h!igh_Difference_Comparison_PyPlots/Projection_Comparison_\AlgoName_k=\kval_h=\hval_N=\Nval_m=\mval_x0=\xB}
		\caption{Projection comparison for $x_0=\xB$ with
			$k=\kval$, $h=\hval$, $N=\Nval$, $m=\mval$.}
...
\subsection{SE2}
{
	...
	\newcommand{\xA}{2.00, 2.12}
	\newcommand{\xB}{-2.00, 0.50}
	...
	\begin{figure}[h!]
		\centering
		\includegraphics[width=\textwidth]{../Images/Projection_Comparison_PyPlots/h!igh_Difference_Comparison_PyPlots/Projection_Comparison_\AlgoName_k=\kval_h=\hval_N=\Nval_m=\mval_x0=\xA}
		\caption{Projection comparison for $x_0=\xA$ with
			$k=\kval$, $h=\hval$, $N=\Nval$, $m=\mval$.}
		\label{fig:\AlgoName_proj_xa}
	\end{figure}
...
\subsection{MidPoint}
{
	...
	% --------------------------
	% Projection comparison for x0 = xC
	% --------------------------
	\begin{figure}[h!]
	  \centering
	  \includegraphics[width=\textwidth]{../Images/Projection_Comparison_PyPlots/h!igh_Difference_Comparison_PyPlots/Projection_Comparison_\AlgoName_k=\kval_h=\hval_N=\Nval_m=\mval_x0=\xC}
	  \caption{Projection comparison for $x_0=\xC$ with
	  $k=\kval$, $h=\hval$, $N=\Nval$, $m=\mval$.}
